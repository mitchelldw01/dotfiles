# Generated by Powerlevel10k configuration wizard on 2024-12-17 at 22:10 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_NUM_MODIFIED || VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_UNTRACKED )); then
      res+=" ${modified}*"
    fi
